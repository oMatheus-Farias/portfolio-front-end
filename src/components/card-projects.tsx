...
const CardProjects = ({ image, name }: CardProjectsProps) => {
  return (
    <div className="relative h-[280px] w-[390px] overflow-hidden rounded-[10px] border-[3px] border-secondary grayscale transition-all duration-200 ease-linear hover:scale-[1.02] hover:grayscale-0 lg:h-[350px] lg:w-[550px]">
