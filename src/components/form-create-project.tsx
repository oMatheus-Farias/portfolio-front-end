...
const FormCreateProject = ({ setOpenDialog }: FormCreateProjectProps) => {
  ...
  const mutation = useMutation({
    mutationFn: async (data: IProjectCreate) => {
      return axios.post(
        import.meta.env.VITE_URL_CREATE_PROJECT,
        { ...data },
        {
          headers: {
  ...
  const handleCreateUserClick = (data: FormData) => {
    ...
    mutation.mutate(createProjectFields)
  }
  ...
  return (
    <Form {...form}>
      <form
        ...
        onSubmit={form.handleSubmit(handleCreateUserClick)}
      >
        <FormField
          name="name"
